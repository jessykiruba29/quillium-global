...
- 🎯 Includes smart distractors  
- 🔹 Click an answer to reveal correctness  

### 📚 Flashcards
- 🔄 Flip to reveal answers  
- ⬅️➡️ Navigate between cards with next/previous buttons  
...
## 📌 Notes
- ⚠️ PDFs should be text-based, not scanned images  
